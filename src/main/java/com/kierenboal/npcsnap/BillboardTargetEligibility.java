...
final class BillboardTargetEligibility
{
	...
	boolean actor(LocalPoint localPlayerLocation, LocalPoint actorLocation, Actor actor, Rectangle viewport)
	{
	...
	boolean projectile(LocalPoint localPlayerLocation, Projectile projectile, Rectangle viewport)
	{
	...
	boolean graphicsObject(LocalPoint localPlayerLocation, GraphicsObject object, Rectangle viewport)
	{
	...
	boolean actorSpotAnimation(Actor actor, ActorSpotAnim spotAnimation, Rectangle viewport)
	{
	...
	boolean groundItem(LocalPoint localPlayerLocation, TileItem item, GroundItemBillboard groundItem, Rectangle viewport)
	{
	...
	boolean tileObject(LocalPoint localPlayerLocation, ObservedTileObject observed, Rectangle viewport)
	{
