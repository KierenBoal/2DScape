...
final class BillboardAngleUtils
{
	static final int LEGACY_FULL_CIRCLE = 2048;
	static final int BILLBOARD_FULL_CIRCLE = 16384;
	static final int CAMERA_FULL_CIRCLE = BILLBOARD_FULL_CIRCLE;
	static final int ACTOR_FULL_CIRCLE = LEGACY_FULL_CIRCLE;
	static final int PROJECTILE_FULL_CIRCLE = LEGACY_FULL_CIRCLE;
	static final int MAX_PITCH = angleToBillboardUnits(512, LEGACY_FULL_CIRCLE);
	static final int GROUND_ITEM_MIN_PITCH = angleToBillboardUnits(128, LEGACY_FULL_CIRCLE);
	static final int COMBAT_YAW = angleToBillboardUnits(512, LEGACY_FULL_CIRCLE);
	static final int OPPOSITE_COMBAT_YAW = angleToBillboardUnits(1536, LEGACY_FULL_CIRCLE);
	...
	static int combatYaw(int rawRelativeYaw)
	{
	...
	static int snapJauByAngles(int jau, int angleCount)
	{
	...
	static int snapPitchByAngles(int pitch, int minPitch, int angleCount)
	{
