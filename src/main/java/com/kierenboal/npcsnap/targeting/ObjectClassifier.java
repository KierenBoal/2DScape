...
public final class ObjectClassifier
{
	...
	public static ClassifiedObjectType classifyRenderable(Renderable renderable)
	{
		return classifyRenderableDecision(renderable).classification;
	}

	public static ClassificationDecision classifyRenderableDecision(Renderable renderable)
	{
		if (renderable == null)
		{
	...
	public static ClassifiedObjectType classifyTileObject(TileObject tileObject, Client client)
	{
		return classifyTileObjectDecision(tileObject, client).classification;
	}

	public static ClassificationDecision classifyTileObjectDecision(TileObject tileObject, Client client)
	{
		if (tileObject == null)
		{
	...
	public static boolean isEnabled(ClassifiedObjectType classifiedType, NpcSnapConfig config)
	{
	...
	public static int renderPriority(ClassifiedObjectType classifiedType)
	{
	...
	public static final class ClassificationDecision
	{
