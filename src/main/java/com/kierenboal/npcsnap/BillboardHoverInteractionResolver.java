...
final class BillboardHoverInteractionResolver
{
	private BillboardHoverInteractionResolver()
	{
	}

	static Actor hoveredActor(Client client)
	{
	...
	static Actor interactedActor(Client client, Actor explicitInteraction)
	{
	...
	static boolean isActorHoverAction(MenuAction action)
	{
		if (action == null)
		{
			return false;
	...
	static boolean isActorInteractionAction(MenuAction action)
	{
