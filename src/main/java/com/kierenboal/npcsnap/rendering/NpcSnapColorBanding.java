...
public final class NpcSnapColorBanding
{
	private NpcSnapColorBanding()
	{
	}

	public static Color snapToRamp(Color color, int colorBands)
	{
	...
	public static int snapRgb(int red, int green, int blue, int colorBands)
	{
	...
	public static int snapTexturePixel(int pixel, int colorBands)
	{
	...
	public static int[] bandPixels(int[] pixels, int colorBands)
	{
	...
	public static int[] bandSpritePixels(int[] pixels, int colorBands)
	{
		if (pixels == null || pixels.length == 0)
		{
			return new int[0];
	...
	public static void applyBandsInPlace(int[] pixels, int colorBands)
	{
		if (pixels == null || pixels.length == 0)
		{
			return;
