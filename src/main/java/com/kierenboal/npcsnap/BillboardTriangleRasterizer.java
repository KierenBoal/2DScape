...
final class BillboardTriangleRasterizer
{
	...
	static void rasterizeSolidTriangle(
		int[] pixels,
		int width,
		int height,
		float x0,
	...
	static int blendPixel(int destination, int source)
	{
	...
	static int clampRasterCoordinate(int coordinate, int dimension)
	{
