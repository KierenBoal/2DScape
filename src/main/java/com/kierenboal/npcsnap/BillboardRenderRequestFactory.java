...
final class BillboardRenderRequestFactory
{
	...
	BillboardRenderRequest build(BillboardTarget target)
	{
		switch (target.type)
		{
			case NPC:
	...
	BillboardRenderRequest build(BillboardTarget target, ObjectRenderablePart part)
	{
	...
	BillboardRenderRequest buildActor(Actor actor)
	{
	...
	BillboardRenderRequest buildStaticObjectPart(ObjectRenderablePart part)
	{
		return request(
			part.renderable, part.renderable.getModel(), part.localPoint, part.plane, 0,
			orientationCalculator.relativeYaw(), orientationCalculator.relativePitch(),
	...
	BillboardRenderRequest buildActorSpotAnimation(ActorSpotAnim spotAnimation, Actor actor)
	{
	...
	BillboardRenderRequest buildProjectile(Projectile projectile)
	{
	...
	BillboardRenderRequest buildGraphicsObject(GraphicsObject graphicsObject)
	{
	...
	BillboardRenderRequest buildGroundItem(TileItem item, GroundItemBillboard groundItem)
	{
		if (groundItem == null)
		{
			return null;
